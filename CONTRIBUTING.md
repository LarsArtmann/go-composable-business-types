# Contributing to go-composable-business-types
...
git clone https://github.com/LarsArtmann/go-composable-business-types.git
cd go-composable-business-types
...
│   └── go-composable-business-types/main.go
...
└── go-composable-business-types.go     # Module definition
```
...
_Thank you for contributing to go-composable-business-types!_
