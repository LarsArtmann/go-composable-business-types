...
require (
	...
	github.com/larsartmann/go-composable-business-types/datapoint v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/larsartmann/go-composable-business-types/datapoint => ../datapoint
